...
<!-- Mirrored from ableproadmin.com/bootstrap/default/auth-change-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Jan 2021 15:28:50 GMT -->
					...
					<div class="card-body">
                        <form action="" method="post">
						    ...
						    <div class="form-group mb-3">
							    <label class="floating-label" for="Password1">Current Password</label>
