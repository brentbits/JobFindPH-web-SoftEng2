			...
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							<li><a href="signup.php" target="_blank"><i class="fas fa-user-alt"></i>Create an Applicant | Employer account</a></li>						
							<li><a href="signin.php" target="_blank"><i class="fas fa-sign-in-alt"></i>Sign in</a></li>									
						</ul>
					</li>																																			
				</ul>												
			</div>
